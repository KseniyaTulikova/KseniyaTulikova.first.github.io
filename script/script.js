$(function() {
    ...
    $(".slide").on("click", function() {
        var images = $(".slide");
        images.siblings().removeClass("show");
        var newIndex = images.index(this) < images.length-1 ? images.index(this)+1 : 0;
        images.eq(newIndex).addClass("show");
    });
